...
static const struct regmap_config spmi_regmap_config = {
	...
	/*
	 * The SPMI driver wraps all commands with a mutex, so there is no need
	 * for regmap to do its own locking. Furthermore regmap does a
	 * spinlock, and mutex-inside-spinlock is illegal.
	 */
